...
<div className='App' id='app1'>
  ...
  <section className='popular-items'>
    <h1 style={{fontFamily: 'Poppins-SemiBold'}}>Popular Items</h1>
    ...
    <p style={{fontFamily: 'Poppins-Regular'}}>Premium beef, hand-selected for it's richness of flavor and tender texture. This steak along with being coated in some of our personal blend of spices and cooking techniques is seared to perfection. The perfect meal for a perfect day.</p>
